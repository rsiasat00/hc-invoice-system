                        ...
                        <form method="post" action="{{ route('invoice.update', $invoice) }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="name" id="input-name" class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Name') }}" value="{{ old('name', $invoice->name) }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('address') ? ' has-danger' : '' }}">
                                    ...
                                    <textarea rows="5" name="address" id="input-address" class="form-control form-control-alternative{{ $errors->has('address') ? ' is-invalid' : '' }}" placeholder="{{ __('Address') }}" required>{{ old('address', $invoice->address) }}</textarea>
                                ...
                                <div class="form-group{{ $errors->has('invoice_date') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="date" name="invoice_date" id="input-invoice-date" class="form-control form-control-alternative{{ $errors->has('invoice_date') ? ' is-invalid' : '' }}" placeholder="{{ __('Invoice Date') }}" value="{{ old('invoice_date', $invoice->invoice_date) }}" required>
                                ...
                                <div class="form-group{{ $errors->has('invoice_number') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" name="invoice_number" id="input-invoice-number" class="form-control form-control-alternative{{ $errors->has('invoice_number') ? ' is-invalid' : '' }}" placeholder="{{ __('Invoice Number') }}" value="{{ old('invoice_number', $invoice->invoice_number) }}" required>
                                ...
                                <div class="form-group{{ $errors->has('due_date') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="date" name="due_date" id="input-due-date" class="form-control form-control-alternative{{ $errors->has('due_date') ? ' is-invalid' : '' }}" placeholder="{{ __('Due Date') }}" value="{{ old('due_date', $invoice->due_date) }}" required>
                                ...
                                <div class="form-group{{ $errors->has('note') ? ' has-danger' : '' }}">
                                    ...
                                    <textarea rows="5" name="note" id="input-note" class="form-control form-control-alternative{{ $errors->has('note') ? ' is-invalid' : '' }}" placeholder="{{ __('Note') }}" required>{{ old('note', $invoice->note) }}</textarea>
