                        ...
                        <form method="post" action="{{ route('product.store') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('tax') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" name="tax" id="input-tax" class="form-control form-control-alternative{{ $errors->has('tax') ? ' is-invalid' : '' }}" placeholder="{{ __('Tax') }}" value="{{ old('tax') }}" required>
